              ...
              {user ? (
                ...
                <>
                  <div className="bg-white/20 dark:bg-slate-800/30 backdrop-blur-md rounded-full border border-white/20 dark:border-slate-700/50 shadow-lg">
                    <Button asChild variant="ghost" className="text-slate-700 dark:text-slate-200 hover:bg-white/10 dark:hover:bg-slate-700/30 transition-all duration-300 border-0 bg-transparent">
                      <Link href="/login">
                        Sign In
                      </Link>
                    </Button>
